          ...
          <div className="lg:w-[570px]">
            <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
              ...
              <p className="text__para">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. reprehenderit veritatis itaque voluptas, corporis tempora exercitationem 
                repellendus adipisci est ullam dolores ipsa autem.
              </p>
  ...
  {/*----- Feature Section*/}
    ...
    <div className="container">
      ...
      <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
            ...
            <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:px-[26px] rounded-[10px]">
